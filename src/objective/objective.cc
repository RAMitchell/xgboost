...
DMLC_REGISTRY_LINK_TAG(normal_obj);
DMLC_REGISTRY_LINK_TAG(poisson_obj);
DMLC_REGISTRY_LINK_TAG(pseudohuber_obj);
DMLC_REGISTRY_LINK_TAG(intercept_solver);
